...
class ShareReadMoreText extends StatefulWidget {
  ...
  @override
  State<ShareReadMoreText> createState() => _ShareReadMoreTextState();
}

class _ShareReadMoreTextState extends State<ShareReadMoreText> {
  @override
