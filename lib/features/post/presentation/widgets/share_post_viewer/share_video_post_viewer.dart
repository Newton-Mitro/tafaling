...
class ShareVideoPostViewer extends StatefulWidget {
  const ShareVideoPostViewer({
    super.key,
  ...
  @override
  State<ShareVideoPostViewer> createState() => _ShareMyVideoPlayerState();
}

class _ShareMyVideoPlayerState extends State<ShareVideoPostViewer> {
              ...
              Positioned(
                ...
                child: SliderTheme(
                  data: SliderTheme.of(context).copyWith(
                    ...
                    overlayColor: Colors.black26.withOpacity(
                      0.2,
                    ), // Lighter overlay
                  ),
                  child: Slider(
